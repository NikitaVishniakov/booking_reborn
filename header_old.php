...
<head>
    ...
    <link rel="stylesheet" href="/libs/air-datepicker/dist/css/datepicker.min.css" type="text/css">
        ...
        <div class="continer">
             <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    <li class="<?php if(preg_match('/incomes.php/', $_SERVER['REQUEST_URI'])){echo "active";}?>"><a href="index.php"><span class="glyphicon glyphicon-calendar"></span> Таблица бронирований</a></li>
                    <li class="<?php if(preg_match('/incomes.php/', $_SERVER['REQUEST_URI'])){echo "active";}?>"><a href="finance.php"><span class="glyphicon glyphicon-ruble"></span> Касса</a></li>
                    <?php if($admin){ ?>
                        ...
                        <li class="<?php if(preg_match('/users_list.php/', $_SERVER['REQUEST_URI'])){echo "active";}?>"><a href="users.php"><span class="glyphicon glyphicon glyphicon-user"></span> Пользователи</a></li>
