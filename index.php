        ...
        <header>
            <div class="header-wrapper">
                <div class="logo float-left">
                    <a href="#carousel"><img id="logo" src="pics/logotip.png"></a>
                </div>
...
<!--                <li><a href="#contacts">Блог</a></li>-->
            ...
            <a href="javascript:void(0)" class="btn-menu-mobile"><img alt="menu-mobile" src="icons-mini/white-menu-icon.png"></a>
            <div class="clear"></div>
        </nav>
                    ...
                    <div class="room-block-body bottom-room">
                        <div class="room-img-slider">
                            <div class="room-img" title="images-standart">
                                <img src="standart/1_1.jpg">
                            </div>
                            <div class="img-row-bottom"  id="images-standart">
                                <img src="standart/1_1.jpg">
                                <img src="standart/1_4.jpg">
                                <img src="standart/1_2.jpg">
                                <img src="standart/1_3.jpg">
                            </div>
                        </div>
                        <div class="room-description">
                                <div class="room-header-block float-left">
                                    <h3 class="room-header">Стандартная категория</h3>
                                    <p class="decription-text">Стандартный номер прекрасно подходит для размещения одного человека или семейной пары. Номер оборудован двухспальной кроватью. Свой санузел с полотенцем и гигиеническим набором. Площадь номеров этой категории -  10-12 кв. м</p>
                                </div>
                                    <div class="clear"></div>
                    ...
                    <div class="room-block-body">
                        <div class="room-img-slider">
                            <div class="room-img" title="images-superior">
                                <img src="superior/pushk9_01.jpg">
                            </div>
                            <div class="img-row-bottom" id="images-superior">
                                <img src="superior/pushk9_01.jpg">
                                <img src="superior/pushk9_02.jpg">
                                <img src="superior/pushk9_04.jpg">
                                <img src="superior/pushk9_05.jpg">
                                <img src="superior/pushk9_06.jpg">
                                <img src="superior/pushk9_09.jpg">
                                <img src="superior/pushk9_13.jpg">
                                <img src="superior/pushk9_14.jpg">
                            </div>
                        </div>
                        <div class="room-description">
                                <div class="room-header-block float-left">
                                    <h3 class="room-header">Улучшенная категория</h3>
                                    <p class="decription-text"> Улучшенный номер - номер повышенного комфорта. Площадь номеров этой категории - 18-22кв. м. Есть возможность выбрать номер с двухспальной кроватью, двумя односпальными или тремя односпальными кроватями</p>
                                </div>
                                    <div class="clear"></div>
                             <ul class="room-description-list">
...
<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A9bb5b3de47e84e72265ba09e3902699bddbe51c115c65245343647ccc5e8a708&amp;width=100%25&amp;height=100%&amp;lang=ru_RU&amp;scroll=false"></script>
        ...
        <div id="toTop"><img title="Наверх" alt="button_up" src="icons-mini/arrow-up.png"></div>
